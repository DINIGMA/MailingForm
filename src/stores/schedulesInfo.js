...
export const useDataStore = defineStore('dataStore', () => {
  ...
  const getDates = computed(() =>
    whatsappResponse.value ? whatsappResponse.value.data.dates : null
  )

  const getDefualtDayCapacity = computed(() =>
    whatsappResponse.value ? whatsappResponse.value.data.default_day_capacity : null
  )
